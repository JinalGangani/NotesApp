...
//  NotesApp
//
//  Created by JinalGangani on 11/07/21.
//
...
//        let logout = UIBarButtonItem(barButtonSystemItem: .close, target: self, action: #selector(    ))
//        navigationItem.setRightBarButton(logout, animated: true)
